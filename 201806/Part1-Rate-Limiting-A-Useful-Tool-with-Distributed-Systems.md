...
在计算领域，速率限制通常用于控制服务发起或消耗的操作速率，或者是请求发送或接收的流量。 如果你有一年以上的软件开发经验，那么你很有可能遇到这个概念。 但是，和很多软件架构所面临的挑战一样，需要思考的问题总会比实际出现的问题更需要权衡。 本文概述了现代分布式应用程序中的一些关于速率限制的实现方案、优势和挑战。
