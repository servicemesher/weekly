...
本人作者由浅及深，从核心问题的引入到具体模式的代码实现，阐述了微服务两种断路器模式的实现原理、优缺点以及二者的比较。
...
![istio-vs-hystrix.jpg](https://www.exoscale.com/static/syslog/2018-12-13-circuit-breakers-istio-histrix/istio-vs-hystrix.jpg)
...
在他的书《*Release It*》中， [Michael Nygard](https://twitter.com/mtnygard) 使用了这个类比，并为应用于上述超时问题的设计模式提供了一个案例。它背后的流程非常简单:

- 如果调用失败，将失败调用的数量增加1
- 如果失败呼叫次数超过某个阈值，则打开电路
- 如果电路打开，立即返回错误**或默认响应**
...
![state-diagram.svg](https://www.exoscale.com/static/syslog/2018-12-13-circuit-breakers-istio-histrix/state-diagram.svg)
...
![istio-class-diagram.svg](https://www.exoscale.com/static/syslog/2018-12-13-circuit-breakers-istio-histrix/istio-class-diagram.svg)
...
![hystrix-class-diagram.svg](https://www.exoscale.com/static/syslog/2018-12-13-circuit-breakers-istio-histrix/hystrix-class-diagram.svg)
